...
from models.ponita.geometry.rotation import random_matrix as random_so3_matrix
from models.ponita.geometry.rotation_2d import random_so2_matrix
...
class RandomRotate(BaseTransform):
    ...
    def __init__(self, attr_list, n=3):
        ...
        self.random_rotation_matrix_fn = (
            random_so2_matrix if (n == 2) else random_so3_matrix
        )
    ...
    def random_rotation(self, graph):
        if graph.batch is not None:
            ...
            random_rotation_matrix = self.random_rotation_matrix_fn(batch_size).to(
                graph.batch.device
            )
